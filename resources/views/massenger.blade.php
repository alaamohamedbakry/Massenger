...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/js/css/template.dark.bundle.css') }}" media="(prefers-color-scheme: dark)">
    </head>
                                        ...
                                        <a href="{{ route('messenger',$chat->id) }}" class="card border-0 text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <span class="avatar-text">{{ strtoupper(substr($chat->participents[0]->name,0,1)) }}</span>
                                                        </div>
                                                    </div>

                                                    <div class="col">
                                                        <div class="d-flex align-items-center mb-3">
                                                            <h5 class="me-auto mb-0">{{ $chat->participents[0]->name }}</h5>
                ...
                <div class="container h-100">
                    ...
                    <div class="d-flex flex-column h-100 position-relative">
                        ...
                        <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                            ...
                            <!-- Chat: Form -->
                            <form class="chat-form rounded-pill bg-dark" data-emoji-form="" method="post" action={{ route('api.masseges.store') }}>
                                <input type="hidden" name="convegration_id" value="{{ $active_chat ? $active_chat->id : '' }}">
                                <div class="row align-items-center gx-0">
                                    <div class="col-auto">
