...
<head>
    ...
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('assets/js/css/template.bundle.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/js/css/template.dark.bundle.css') }}"
...
<body>
    ...
    <div class="overflow-hidden layout">
        <!-- Navigation -->
        <nav class="text-center navigation d-flex flex-column navbar navbar-light hide-scrollbar">
            <!-- Brand -->
            <a href="index.html" title="Messenger" class="mb-6 d-none d-xl-block">
            ...
            <!-- Nav items -->
            <ul class="flex-row py-4 d-flex nav navbar-nav flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-lg-2 px-lg-3"
                role="tablist">
                <!-- Invisible item to center nav vertically -->
                <li class="invisible nav-item d-none d-xl-block flex-xl-grow-1">
                    <a class="py-0 nav-link py-lg-8" href="#" title="">
                ...
                <!-- New chat -->
                <li class="nav-item">
                    <a class="py-0 nav-link py-lg-8" id="tab-create-chat" href="#tab-content-create-chat"
                ...
                <!-- Friends -->
                <li class="nav-item">
                    <a class="py-0 nav-link py-lg-8" id="tab-friends" href="#tab-content-friends" title="Friends"
                ...
                <!-- Chats -->
                <li class="nav-item">
                    <a class="py-0 nav-link active py-lg-8" id="tab-chats" href="#tab-content-chats" title="Chats"
                        data-bs-toggle="tab" role="tab">
                ...
                <!-- Notification -->
                <li class="nav-item">
                    <a class="py-0 nav-link py-lg-8" id="tab-notifications" href="#tab-content-notifications"
                ...
                <li class="nav-item d-none d-xl-block flex-xl-grow-1">
                    <a class="py-0 nav-link py-lg-8" id="tab-support" href="#tab-content-support" title="Support"
                        data-bs-toggle="tab" role="tab">
                        <div class="icon icon-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <li class="nav-item d-none d-xl-block">
                    <a class="py-0 nav-link py-lg-8" id="tab-settings" href="#tab-content-settings" title="Settings"
                        data-bs-toggle="tab" role="tab">
                        <div class="icon icon-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <!-- Profile -->
                <li class="nav-item">
                    <a href="#" class="p-0 nav-link mt-lg-2" data-bs-toggle="modal"
                        data-bs-target="#modal-profile">
                        <div class="mx-auto avatar avatar-online d-none d-xl-block">
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar">
                            ...
                            <div class="container py-8">
                                ...
                                <!-- Title -->
                                <div class="mb-8">
                                    <h2 class="m-0 fw-bold">Create chat</h2>
                                </div>
                                ...
                                <div class="tab-content" role="tablist">
                                    <div class="tab-pane fade show active" id="create-chat-info" role="tabpanel">
                                            ...
                                            <div class="profile">
                                                ...
                                                <div class="p-0 profile-body">
                                                    <div class="avatar avatar-lg">
                                                        ...
                                                        <div
                                                            class="bottom-0 badge badge-lg badge-circle bg-primary border-outline position-absolute end-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                        ...
                                                        <label class="mb-0 stretched-label"
                                        ...
                                        <div class="px-6 mt-4 d-flex align-items-center">
                                        ...
                                        <!-- Options -->
                                        <div class="mt-8">
                                            <div class="px-6 mb-4 d-flex align-items-center">
                        ...
                        <!-- Button -->
                        <div class="container mb-8 mt-n4 position-relative">
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <!-- Title -->
                                <div class="mb-8">
                                    <h2 class="m-0 fw-bold">Friends</h2>
                                </div>
                                ...
                                <div class="card-list">
                                    ...
                                    @foreach ($friends as $friend)
                                        ...
                                        @if ($letter != $last_letter)
                                            ...
                                            @php
                                                $last_letter = $letter; // تصحيح تحديث القيمة
                                            @endphp
                                        @endif
                                        <!-- Card -->
                                        <div class="border-0 card">
                                ...
                                <div class="card-list">
                                    @foreach ($chats as $chat)
                                        ...
                                        <a href="{{ route('messenger', $chat->id) }}"
                                            class="border-0 card text-reset">
                                            <div class="card-body">
                                                <div class="row gx-5">
                                                    <div class="col-auto">
                                                        <div class="avatar avatar-online">
                                                            <span
                                                                class="avatar-text">{{ strtoupper(substr($chat->participents[0]->name, 0, 1)) }}</span>
                                                        </div>
                                                    </div>

                                                    <div class="col">
                                                        <div class="mb-3 d-flex align-items-center">
                                                            <h5 class="mb-0 me-auto">{{ $chat->participents[0]->name }}
                                                            </h5>
                                                            <span
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <!-- Title -->
                                <div class="mb-8">
                                    <h2 class="m-0 fw-bold">Notifications</h2>
                                </div>
                                ...
                                <div class="card-list">
                                    <!-- Title -->
                                    <div class="px-6 my-4 d-flex align-items-center">
                                            ...
                                            <div class="row gx-5">
                                                <div class="col-auto">
                                                    ...
                                                    <a href="#" class="avatar">
                                                        ...
                                                        <div
                                                            class="bottom-0 badge badge-circle bg-primary border-outline position-absolute end-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="row gx-5">
                                                <div class="col-auto">
                                                    ...
                                                    <a href="#" class="avatar">
                                                        ...
                                                        <div
                                                            class="bottom-0 badge badge-circle bg-warning border-outline position-absolute end-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div class="row gx-5">
                                                <div class="col-auto">
                                                    ...
                                                    <div class="avatar">
                                                        ...
                                                        <div
                                                            class="bottom-0 badge badge-circle bg-success border-outline position-absolute end-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <div class="col">
                                                    <div class="mb-2 d-flex align-items-center">
                                                        <h5 class="mb-0 me-auto">Password Changed</h5>
                                                        <span class="extra-small text-muted ms-2">08:45 PM</span>
                                                    </div>
                                            ...
                                            <div class="row gx-5">
                                                <div class="col-auto">
                                                    ...
                                                    <a href="#tab-settings" class="avatar avatar-badged"
                                                        ...
                                                        <div
                                                            class="bottom-0 badge badge-circle bg-danger border-outline position-absolute end-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <!-- Title -->
                                <div class="mb-8">
                                    <h2 class="m-0 fw-bold">Support</h2>
                                </div>
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <!-- Title -->
                                <div class="mb-8">
                                    <h2 class="m-0 fw-bold">Settings</h2>
                                </div>
                                        ...
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <div class="avatar">
                                                    ...
                                                    <div
                                                        class="bottom-0 badge badge-circle bg-secondary border-outline position-absolute end-0">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
        ...
        <main class="main is-visible" data-dropzone-area="">
            <div class="container h-100">
                ...
                <div class="d-flex flex-column h-100 position-relative">
                    <!-- Chat: Header -->
                    <div class="py-4 chat-header border-bottom py-lg-7">
                        <div class="row align-items-center">
                            ...
                            <div class="col-8 col-xl-12">
                                <div class="text-center row align-items-center text-xl-start">
                                    <!-- Title -->
                    ...
                    <div class="flex-1 chat-body hide-scrollbar h-100">
                    ...
                    <!-- Chat: Footer -->
                    <div class="bottom-0 pb-3 chat-footer pb-lg-7 position-absolute start-0">
                        <!-- Chat: Files -->
                        ...
                        <!-- Chat: Form -->
                        <!-- Chat Form -->
                        <form id="chat-form" class="chat-form rounded-pill bg-dark" method="POST" action={{ route('api.masseges.store') }}>
                            @csrf
                            <input type="hidden" name="convegration_id" id="convegration_id"
                                value="{{$active_chat->id}}">

                            <div class="row align-items-center gx-0">
                                <div class="col">
                                    <div class="input-group">
                                        <textarea id="message-input" class="px-0 form-control" name="massege" placeholder="Type your message..."
                                            rows="1"></textarea>
                                    </div>
                                </div>
                                <div class="col-auto">
        ...
        <div class="offcanvas offcanvas-end offcanvas-aside" data-bs-scroll="true" data-bs-backdrop="false"
            ...
            <!-- Offcanvas Header -->
            <div class="py-4 offcanvas-header py-lg-7 border-bottom">
                ...
                <div class="overflow-hidden text-center visibility-xl-invisible">
                    <h5 class="text-truncate">Ollie Chandler</h5>
            ...
            <div class="offcanvas-body hide-scrollbar">
                ...
                <div class="py-10 text-center">
                    <div class="row gy-6">
                        <div class="col-12">
                            <div class="mx-auto avatar avatar-xl">
                                <img src="assets/img/avatars/2.jpg" alt="#" class="avatar-img">

                                <a href="#"
                                    class="bottom-0 text-white badge badge-lg badge-circle bg-primary border-outline position-absolute end-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-plus">
                ...
                <!-- Tabs: Content -->
                <div class="py-2 tab-content" role="tablist">
                    <!-- Profile -->
                    <div class="tab-pane fade show active" id="offcanvas-tab-profile" role="tabpanel">
                        ...
                        <ul class="mt-8 list-group list-group-flush border-top">
                            <li class="list-group-item">
                                <div class="row align-items-center gx-6">
                                    <div class="col">
                                        <h5>Notifications</h5>
                        ...
                        <div class="py-6 row row-cols-3 g-3">
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    ...
                                    <img class="rounded img-fluid" src="assets/img/chat/2.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    ...
                                    <img class="rounded img-fluid" src="assets/img/chat/3.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    data-theme-img-url="assets/img/chat/media-1.jpg">
                                    <img class="rounded img-fluid" src="assets/img/chat/4.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    data-theme-img-url="assets/img/chat/media-2.jpg">
                                    <img class="rounded img-fluid" src="assets/img/chat/5.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    data-theme-img-url="assets/img/chat/media-3.jpg">
                                    <img class="rounded img-fluid" src="assets/img/chat/6.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    data-theme-img-url="assets/img/chat/media-1.jpg">
                                    <img class="rounded img-fluid" src="assets/img/chat/7.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    data-theme-img-url="assets/img/chat/media-2.jpg">
                                    <img class="rounded img-fluid" src="assets/img/chat/8.jpg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                    data-theme-img-url="assets/img/chat/media-3.jpg">
                                    <img class="rounded img-fluid" src="assets/img/chat/9.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="py-0 modal-body">
                    ...
                    <div class="profile modal-gx-n">
                        <div class="profile-img text-primary rounded-top-xl">
                            ...
                            <div class="top-0 p-5 position-absolute start-0">
                                <button type="button" class="opacity-100 btn-close btn-close-white btn-close-arrow"
                        ...
                        <div class="profile-body">
                            ...
                            <h4 class="mb-1 fw-bold">Invite your friends</h4>
                            <p style="font-size: 16px;">Send invitation links to your friends</p>
                        </div>
                    </div>
                    <!-- Header -->

                    <hr class="my-0 hr-bold modal-gx-n">
                ...
                <div class="py-0 modal-body">
                    ...
                    <div class="profile modal-gx-n">
                        <div class="profile-img text-primary rounded-top-xl">
                            ...
                            <div class="top-0 px-5 py-6 position-absolute start-0">
                                <button type="button" class="opacity-100 btn-close btn-close-white btn-close-arrow"
                                    data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                        </div>
   ...
   <script src="https://js.pusher.com/8.2.0/pusher.min.js"></script>
    <script src="{{asset('assets/js/massenger.js')}}"></script>
    <script>
        ...
        var pusher = new Pusher('2f0108e3fd78d2bdde60', {
          cluster: 'mt1',
          authEndpoint: '/broadcasting/auth',
        });

        var channel = pusher.subscripe(`Presence-Massenger.${UserId}`);
        channel.bind('MassegeCreated', function(data) {
